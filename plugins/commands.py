...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL,SUBSCRIPTION, PREMIUM_USER
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🤖 Contact 🤖', url="https://t.me/devildono001BOT"),
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('🤖 Update Channel 🤖', url="https://t.me/updatechannelfordevil")
                            ],
                            [
    ...
    if data.startswith("sendfiles"):
        ...
        await k.edit("<b>ʏᴏᴜʀ ᴍᴇꜱꜱᴀɢᴇ was ᴅᴇʟᴇᴛᴇᴅ !\n\nᴋɪɴᴅʟʏ ꜱᴇᴀʀᴄʜ ᴀɢᴀɪɴ.</b>")
        return
        ...
        for file in files:
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      InlineKeyboardButton("🤖 Update Channel 🤖", url="t.me/updatechannelfordevil")
                     ],
                     [
                        InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @LazyDeveloperr
